<?php
	...
	if(!empty($kind)) $dfgallery = ($kind == 'man_cat') ? 'gallery_cat' : 'gallery';
	if(!empty($kind)) $dfgallery = ($kind == 'man_item') ? 'gallery_item' : 'gallery';
	if(!empty($kind)) $dfgallery = ($kind == 'man_sub') ? 'gallery_sub' : 'gallery';
	else $dfgallery = '';
