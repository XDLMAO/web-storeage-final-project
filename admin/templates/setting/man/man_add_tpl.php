				...
				<div class="row">
					...
					<?php if(isset($config['setting']['copyright']) && $config['setting']['copyright'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							...
							<input type="text" class="form-control text-sm" name="data[options][copyright]" id="copyright" placeholder="Copyright" value="<?=(!empty($flash->has('copyright'))) ? $flash->get('copyright') : @$options['copyright']?>">
						</div>
					<?php } ?>
					...
					<?php } ?>
					<?php if(isset($config['setting']['giomocua']) && $config['setting']['giomocua'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="giomocua">Giờ mở cửa:</label>
							<input type="text" class="form-control text-sm" name="data[options][giomocua]" id="giomocua" placeholder="Giờ mở cửa" value="<?=(!empty($flash->has('giomocua'))) ? $flash->get('giomocua') : @$options['giomocua']?>">
						</div>
					<?php } ?>
					...
					<?php if(isset($config['setting']['link_maps']) && $config['setting']['link_maps'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							...
							<input type="text" class="form-control text-sm" name="data[options][link_maps]" id="link_maps" placeholder="Link Google Maps" value="<?=(!empty($flash->has('link_maps'))) ? $flash->get('link_maps') : @$options['link_maps']?>">
						</div>
					<?php } ?>
					<?php if(isset($config['setting']['messenger']) && $config['setting']['messenger'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="messenger">Link Messenger:</label>
							<input type="text" class="form-control text-sm" name="data[options][messenger]" id="messenger" placeholder="Link Messenger" value="<?=(!empty($flash->has('messenger'))) ? $flash->get('messenger') : @$options['messenger']?>">
						</div>
					<?php } ?>
				</div>
