<?php
    ...
    $linkMulti = "index.php?com=product&act=man_photo&kind=man_cat&type=".$type;
?>
<!-- Content Header -->
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <?php if(isset($config['product'][$type]['gallery_cat']) && count($config['product'][$type]['gallery_cat']) > 0) { ?>
                                    ...
                                    <td class="align-middle">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdown-gallery">
                                                <?php foreach($config['product'][$type]['gallery_cat'] as $key => $value) { ?>
