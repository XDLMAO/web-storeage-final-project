                                        ...
                                        <div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-lang-<?=$k?>" role="tabpanel" aria-labelledby="tabs-lang">
                                            ...
                                            <?php if(isset($config['news'][$type]['link']) && $config['news'][$type]['link'] == true) { ?>
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control for-seo text-sm" name="data[link]" id="link" placeholder="Liên kết" value="<?=(!empty($flash->has('link'))) ? $flash->get('link') : @$item['link']?>">
                                                </div>
                                            <?php } ?>
                                            <?php if(isset($config['news'][$type]['gia']) && $config['news'][$type]['gia'] == true) { ?>
                                                <div class="form-group">
                                                    <label for="gia">Giá:</label>
                                                    <input type="text" class="form-control for-seo text-sm" name="data[gia]" id="gia" placeholder="Giá" value="<?=(!empty($flash->has('gia'))) ? $flash->get('gia') : @$item['gia']?>">
                                                </div>
                                            <?php } ?>
